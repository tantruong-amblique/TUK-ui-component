        ...
        <>
            <div className="w-full h-full bg-gray-200">
                <div className="flex flex-no-wrap">
                    ...
                    <div className="w-64 absolute lg:relative bg-purple-900 shadow md:h-screen flex-col justify-between hidden lg:flex pb-40">
                        <div>
                            ...
                            <ul className="mt-12">
                                <li className="w-full justify-between text-gray-300 hover:text-gray-200 cursor-pointer items-center mb-6 px-8">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {show == 0 ? (
                                            <div onClick={() => setShow(null)} className=" ml-4">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-up" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            ...
                                            <div className="ml-4">
                                                <svg onClick={() => setShow(0)} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    ...
                                    {show == 0 && (
                                        <ul className="my-3 " id="list">
                                            <li className="text-sm text-indigo-500 hover:text-gray-200 py-2 px-6">Best Sellers</li>
                                            <li className="text-sm text-gray-300 hover:text-indigo-500 py-2 px-6">Out of Stock</li>
                                            <li className="text-sm text-gray-300 hover:text-indigo-500 py-2 px-6">New Products</li>
                                        </ul>
                                    )}
                                </li>
                                <li className="flex flex-col w-full text-gray-300 hover:text-gray-200 cursor-pointer px-8">
                                    <div className="w-full flex justify-between items-center">
                                        ...
                                        {show == 1 ? (
                                            <div className=" ml-4">
                                                <svg onClick={() => setShow(null)} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-up" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                    <polyline points="6 15 12 9 18 15" />
                                                </svg>
                                            </div>
                                            ...
                                            <div className="ml-4">
                                                <svg onClick={() => setShow(1)} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                    <polyline points="6 9 12 15 18 9" />
                                                </svg>
                                            </div>
                                ...
                                <li className="w-full justify-between text-gray-300 hover:text-gray-200 cursor-pointer items-center my-6 px-8">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center">
                                        ...
                                        {show == 2 ? (
                                            ...
                                            <div className="ml-4">
                                                <svg onClick={() => setShow(2)} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                    <polyline points="6 9 12 15 18 9" />
                                                </svg>
                                            </div>
                                ...
                                <li className="w-full justify-between text-gray-300 hover:text-gray-200 cursor-pointer items-center mb-6 px-8">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {show == 3 ? (
                                            ...
                                            <div className="ml-4">
                                                <svg onClick={() => setShow(3)} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                    <polyline points="6 9 12 15 18 9" />
                                                </svg>
                                            </div>
                                    ...
                                    <div className="flex itmes-center justify-between">
                                        ...
                                        <div>
                                            {show == 4 ? (
                                                ...
                                                <div className="ml-4">
                                                    <svg onClick={() => setShow(4)} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                        <polyline points="6 9 12 15 18 9" />
                                                    </svg>
                                                </div>
                                ...
                                <li className="w-full justify-between text-gray-300 hover:text-gray-200 cursor-pointer items-center mb-6 px-8">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {show == 5 ? (
                                            ...
                                            <div className="ml-4">
                                                <svg onClick={() => setShow(5)} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                    <polyline points="6 9 12 15 18 9" />
                                                </svg>
                                            </div>
                                ...
                                <li className="flex w-full justify-between text-gray-300 hover:text-gray-200 cursor-pointer items-center px-8">
                                    <div className="flex items-center">
                    ...
                    <div className={menu ? "w-full h-full absolute z-40  transform  translate-x-0 " : "   w-full h-full absolute z-40  transform -translate-x-full"} id="mobile-nav">
                        <div className="bg-gray-800 opacity-50 absolute w-full h-full" onClick={() => setMenu(!menu)} />
                        <div className="md:w-96 w-64 z-40 absolute lg:relative bg-purple-900 shadow overflow-y-auto h-full flex-col justify-between lg:hidden pb-4 transition duration-150 ease-in-out">
                            <div className="flex flex-col justify-between h-full">
                                <div>
                                    <div className="flex items-center justify-between px-8">
                                        ...
                                        <div id="closeSideBar" className="flex items-center justify-end h-10 w-10 text-white" onClick={() => setMenu(!menu)}>
                                        ...
                                        <ul className="mt-12">
                                            <li className="w-full justify-between text-gray-300 hover:text-gray-200 cursor-pointer items-center mb-6 px-8">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    {show == 6 ? (
                                                        <div className=" ml-4" onClick={() => setShow(null)}>
                                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-up" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                                <polyline points="6 15 12 9 18 15" />
                                                            </svg>
                                                        ...
                                                        <div className="ml-4" onClick={() => setShow(6)}>
                                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevron-down" width={20} height={20} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                                <polyline points="6 9 12 15 18 9" />
                                                            </svg>
                                                        </div>
                                                ...
                                                {show == 6 && (
                                                    <ul className="my-3 ">
                                                        <li className="xl:text-base md:text-2xl text-base text-indigo-500 hover:text-gray-200 py-2 px-6">Best Sellers</li>
                                                        <li className="xl:text-base md:text-2xl text-base text-gray-300 hover:text-indigo-500 py-2 px-6">Out of Stock</li>
                                                        <li className="xl:text-base md:text-2xl text-base text-gray-300 hover:text-indigo-500 py-2 px-6">New Products</li>
                                                    </ul>
                                                )}
                                            </li>
                                            <li className="flex flex-col w-full text-gray-300 hover:text-gray-200 cursor-pointer px-8">
                                            ...
                                            <li className="w-full justify-between text-gray-300 hover:text-gray-200 cursor-pointer items-center mb-6 px-8">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        <div className="w-6 h-6 md:w-8 md:h-8">
                                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-stack" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                                <polyline points="12 4 4 8 12 12 20 8 12 4" />
                                                                <polyline points="4 12 12 16 20 12" />
                                                                <polyline points="4 16 12 20 20 16" />
                                            ...
                                            <li className="flex w-full justify-between text-gray-300 hover:text-gray-200 cursor-pointer items-center px-8">
                                                <div className="flex items-center">
                                                    <div className="w-6 h-6 md:w-8 md:h-8">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-settings" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" />
                                                            <path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                                            <circle cx={12} cy={12} r={3} />
                                                        </svg>
                                        ...
                                        <div className="w-full flex items-center justify-between px-6 pt-1">
                                            ...
                                            <ul className="flex">
                                                <li className="cursor-pointer text-white pt-5 pb-3">
                                                    <div className="w-6 h-6 md:w-8 md:h-8">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-messages" viewBox="0 0 24 24" strokeWidth={1} stroke="#FFFFFF" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" />
                                                ...
                                                <li className="cursor-pointer text-white pt-5 pb-3 pl-3">
                                                    <div className="w-6 h-6 md:w-8 md:h-8">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-bell" viewBox="0 0 24 24" strokeWidth={1} stroke="#FFFFFF" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" />
                    ...
                    <div className="w-full">
                        <nav className="h-16 flex items-center lg:items-stretch justify-end lg:justify-between bg-white shadow relative z-10">
                            ...
                            <div className="text-gray-600 mr-8 visible lg:hidden relative" onClick={() => setMenu(!menu)}>
                                {menu ? (
                                    ""
                                ) : (
                                    <svg aria-label="Main Menu" id="menu" aria-haspopup="true" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-menu cursor-pointer" width={30} height={30} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" />
