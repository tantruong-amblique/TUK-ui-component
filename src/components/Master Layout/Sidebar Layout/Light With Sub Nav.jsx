                ...
                <div className="flex flex-no-wrap">
                    ...
                    <div className="absolute lg:relative w-64 h-screen shadow bg-white hidden lg:block">
                        ...
                        <ul aria-orientation="vertical" className="bg-white rounded py-6">
                            <li className="pl-6 cursor-pointer text-white text-sm leading-3 tracking-normal pb-4 pt-5 bg-indigo-700 focus:text-indigo-700 focus:outline-none" onClick={() => setMenu(!menu)}>
                                ...
                                {menu ? (
                                    <ul className="pt-2 ">
                                        <li className="pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2">Stats</li>
                                        <li className="pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2">Lists</li>
                                        <li className="pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 flex items-center ml-2">Tables</li>
                                    </ul>
                                ) : (
                                    ""
                                )}
                            </li>
                            <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onClick={() => setMenu1(!menu1)}>
                                <div className="flex items-center">
                                ...
                                {menu1 ? (
                                    <ul className="pt-2 ">
                                        <li className="pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2">Stats</li>
                                        <li className="pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2">Lists</li>
                                        <li className="pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 flex items-center ml-2">Tables</li>
                                    </ul>
                                ) : (
                                    ""
                                )}
                            </li>
                            <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onClick={() => setMenu2(!menu2)}>
                                <div className="flex items-center">
                            ...
                            <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onClick={() => setMenu3(!menu3)}>
                                <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <ul aria-orientation="vertical" className="bg-white rounded py-6">
                                        <li className="pl-6 cursor-pointer text-white text-sm leading-3 tracking-normal pb-4 pt-5 bg-indigo-700 focus:text-indigo-700 focus:outline-none" onClick={() => setMenu(!menu)}>
                                            ...
                                            {menu ? (
                                                <ul className="pt-2 ">
                                                    <li className="pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2 xl:text-base md:text-2xl text-base">Stats</li>
                                                    <li className="pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2 xl:text-base md:text-2xl text-base">Lists</li>
                                                    <li className="pl-8 cursor-pointer text-white text-xs leading-3 tracking-normal py-2 flex items-center ml-2 xl:text-base md:text-2xl text-base">Tables</li>
                                                </ul>
                                            ) : (
                                                ""
                                            )}
                                        ...
                                        <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onClick={() => setMenu1(!menu1)}>
                                            ...
                                            {menu1 ? (
                                                <ul className="pt-2 ">
                                                    <li className="pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2 xl:text-base md:text-2xl text-base">Stats</li>
                                                    <li className="pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 mb-1 flex items-center ml-2 xl:text-base md:text-2xl text-base">Lists</li>
                                                    <li className="pl-8 cursor-pointer text-indigo-700 text-xs leading-3 tracking-normal py-2 flex items-center ml-2 xl:text-base md:text-2xl text-base">Tables</li>
                                                </ul>
                                            ) : (
                                                ""
                                            )}
