        ...
        <>
            <div className="w-full h-full">
                <div className="flex flex-no-wrap">
                    {/* Sidebar starts */}
                    <div className="w-64 absolute lg:relative bg-gray-800 shadow h-full flex-col justify-between hidden lg:flex pb-12">
                        <div className="px-8">
                            ...
                            <ul className="mt-12">
                                ...
                                <li className="flex w-full justify-between text-gray-500 hover:text-gray-400 cursor-pointer items-center">
                                    <div className="flex items-center">
                    ...
                    <div className={show ? "w-full h-full absolute z-40  transform  translate-x-0 " : "   w-full h-full absolute z-40  transform -translate-x-full"}>
                        <div className="bg-gray-800 opacity-60 w-full h-full absolute" onClick={() => setShow(!show)} />
                                ...
                                <div>
                                    <div className="text-white flex items-center justify-between px-8">
                                        ...
                                        <div onClick={() => setShow(!show)}>
                                            <svg id="cross" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-x" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                    ...
                                                    <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                                                        <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center">
                                                            <div className="flex items-center">
                                                                ...
                                                                <span className="xl:text-base md:text-2xl text-base ml-2">My Profile</span>
                                                            </div>
                                                        </li>
                                                        <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mt-2">
                                                            <div className="flex items-center">
                                                                ...
                                                                <span className="xl:text-base md:text-2xl text-base ml-2">Sign out</span>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                ) : (
